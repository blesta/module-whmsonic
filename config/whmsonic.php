...
Panel URL: http://{service.whmsonic_ip_address}:{service.whmsonic_port}/
...
<p>WHMSonic Panel & FTP Account:<br />Panel URL: http://{service.whmsonic_ip_address}:{service.whmsonic_port}/<br />FTP Host/IP: {service.whmsonic_ip_address}<br />Username: {service.whmsonic_username} <br />Password: {service.whmsonic_password}</p>
